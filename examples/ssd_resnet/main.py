...
class RunnerBase:
    def __init__(self, bmodel, ds, threads, post_proc=None, max_batchsize=128):
...
def main():
    ...
    runner = runner_map[scenario](bmodel, ds, args.threads, post_proc=post_proc, max_batchsize=args.max_batchsize)
